    ...
    return (
        ...
        >
            <button
                ...
                className={`inline-flex justify-between w-full h-[44px] ${isOpen ? "rounded-t-[4px] border-b-[1px]" : "rounded-[4px] border-none "} px-4 py-2 bg-white text-[#2F3032] font-medium flex items-center`}
            >
