...
export const RoleCard = ({
    ...
    return (
        <div
            className={`cursor-pointer group flex flex-col ${isManeger ? "w-[395px] hover:w-[498px]" : " w-[231px] hover:w-[498px]"} h-[592px] max-w-[498px]  border border-[#666666] flex-shrink-0 transition-all duration-500 px-5 py-[26px] rounded-[12px] backdrop-blur-[20px] bg-[linear-gradient(180deg,rgba(0,0,0,0.24)_0%,rgba(198,105,25,0.36)_100%)] overflow-hidden`}
        >
            <div>
                {/* Title & subtitle */}
