...
export const RoleCard = ({
    ...
    return (
        <div className="cursor-pointer group flex flex-col w-[98px] sm:w-[231px] h-66 sm:h-[592px] max-w-[478px] hover:w-[592px] border border-[#666666] flex-shrink-0 transition-all duration-500 px-3 sm:px-5 py-5 sm:py-[26px] rounded-[8px] sm:rounded-[12px] backdrop-blur-[20px] bg-[linear-gradient(180deg,rgba(0,0,0,0.24)_0%,rgba(198,105,25,0.36)_100%)] overflow-hidden">
            <div>
                {/* Title & subtitle */}
                ...
                <div className="flex flex-col transform  opacity-0 group-hover:translate-x-0  group-hover:opacity-100 transition-all duration-200 group-hover:duration-800 ease-in text-[#c4c4c4] whitespace-pre-line">
                    <div>
                        <div className="font-semibold text-sm sm:text-[18px] mt-4 sm:mt-[52px]">
                            무슨 일을 하나요?
                        </div>
                    ...
                    <div>
                        <div className="font-semibold text-[18px] mt-4 sm:mt-[52px]">
                            어떤 역량이 필요할까요?
                        </div>
                        <div className="font-light text-xs sm:text-base mt-2 sm:mt-3 leading-[160%]">
                            {description2}
